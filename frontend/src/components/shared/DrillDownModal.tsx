                ...
                >
                  ...
                  {type === 'ship_now' && (
                    <>
                      ...
                      <td className="py-3 px-2 text-right font-data text-[11px] text-white font-bold"><span className="inline-block transition-transform duration-300 group-hover:scale-[1.15] origin-center">{item.current_minutes_stock_units ?? 0}</span></td>
