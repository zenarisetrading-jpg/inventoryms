          ...
          <table className="w-full text-left border-collapse min-w-[1400px]">
            <thead className="sticky top-0 z-20 bg-[#111827] shadow-none border-white/10">
              <tr className="border-b border-zinc-200">
                <th onClick={() => toggleSort('total_units')} className="px-6 py-5 text-[11px] font-black text-white uppercase tracking-widest w-16 cursor-pointer hover:text-brand-blue text-center">#</th>
                <th onClick={() => toggleSort('category')} className="px-8 py-5 text-[11px] font-black text-white uppercase tracking-widest cursor-pointer hover:text-brand-blue">Class</th>
                <th onClick={() => toggleSort('product_category')} className="px-8 py-5 text-[11px] font-black text-white uppercase tracking-widest cursor-pointer hover:text-brand-blue">Category</th>
                <th onClick={() => toggleSort('sub_category')} className="px-8 py-5 text-[11px] font-black text-white uppercase tracking-widest cursor-pointer hover:text-brand-blue">Sub-Category</th>
                <th onClick={() => toggleSort('sku')} className="px-8 py-5 text-[11px] font-black text-white uppercase tracking-widest cursor-pointer hover:text-brand-blue">SKU</th>
