const url = 'https://eiezhzlpirdiqsotvogx.supabase.co/rest/v1/audit_fact_purchase?select=*'
const headers = {
...
fetch(url, { headers })
.then(r => r.json())
.then(data => console.log('Audit records count:', data.length, data.slice(0, 2)))
